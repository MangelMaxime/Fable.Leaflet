...
type DoneCallback =
    (System.Exception -> HTMLElement -> unit)
...
module SVG =
    ...
    type [<AllowNullLiteral>] IExports =
        abstract create: name: string -> obj // should be SVGElement: We are waiting after https://github.com/fable-compiler/fable-browser/issues/6
